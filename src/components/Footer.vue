<template>
    <div class="__b _flex __bg-grey-4">
        <div class="__b __bo-flag-1 _fw-wr __bod __w _ai-ce __mauto _flex __padxs">
            <p class="__txt-grey-10">&copy; RepeatBeats {{ thisYear }}</p> &nbsp; &nbsp;
